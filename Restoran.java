...
class Jelo {
    ...
    void setNizNamirnica(Namirnica[] potrebneNamirnice) {
        this.potrebneNamirnice = potrebneNamirnice;
    }
...
class Meni {
    ...
    public Meni(String fajl) throws IOException {
        ...
        while (linija != null) {
            ...
            while ((tokeni.length - 2) > j) {
                potrebno[j].setNaziv(tokeni[j + 2].trim());
            }
    ...
    /// potrebne namernice porediti sa onima u listi
    /// iscitati iz fajla u listu sve namernice i proveravati da li za jelo koje je
    /// naruceno imaju namirnice
}
